                ...
                {slides.map(slide => (
                    ...
                    >
                        ...
                        <div className="absolute inset-0   flex flex-col items-center justify-center  text-center px-4">
                            <motion.h1
                                className="text-3xl sm:text-4xl md:text-5xl text-white font-bold mb-4 bg-black bg-opacity-40 backdrop-blur-sm px-4 py-2 rounded"
                            ...
                            <motion.p
                                className="text-base sm:text-lg md:text-xl text-white bg-black bg-opacity-30 backdrop-blur-sm px-4 py-2 rounded mb-6"
                                initial={{ opacity: 0, y: 30 }}
                                animate={{ opacity: 1, y: 0 }}
