   ...
   useEffect(() => {
    AOS.init({
     ...
     <div className="bg-white py-12 px-6 md:px-20">
      <h2   className="text-3xl font-bold text-center mb-8 text-primary">Why Choose Our Hotel?</h2>
      <div className="grid md:grid-cols-3 gap-8 text-center">
        <div data-aos="fade-up" className="p-6 border-2 border-neutral rounded-lg hover:shadow-xl transition">
          <img src="https://i.ibb.co/2YtT0qm4/b-logo-design-vector-image-1041649-2996.jpg" alt="Luxury" className="w-16 mx-auto mb-4" />
          <h4 className="text-xl text-neutral font-semibold mb-2">Luxury & Comfort</h4>
        ...
        <div data-aos="fade-up" className="p-6 border-2 border-neutral rounded-lg hover:shadow-xl transition">
          ...
          <h4 className="text-xl text-neutral font-semibold mb-2">24/7 Service</h4>
        ...
        <div data-aos="fade-up" className="p-6 border-2 border-neutral rounded-lg hover:shadow-xl transition">
          ...
          <h4 className="text-xl text-neutral font-semibold mb-2">Secure & Safe</h4>
